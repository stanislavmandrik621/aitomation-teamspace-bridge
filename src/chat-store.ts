...
export class ChatStore {
  ...
  edit(
    ...
    return this.inner.edit(messageId, editorMemberId, newBody, isAdmin, roomHint, editWindowMs, authorize)
  }
  ...
  react(
    ...
    return this.inner.react(messageId, memberId, emoji, remove, roomHint, authorize)
  }

  /** Pin one message. Already pinned is `unchanged`, a full room refuses. */
  pinMessage(roomId: string, messageId: string, byAdmin: boolean, authorize?: () => boolean): Promise<ChatPinWriteResult> {
    return this.inner.pinMessage(roomId, messageId, byAdmin, authorize)
  }
  ...
  unpinMessage(
    ...
    return this.inner.unpinMessage(roomId, messageId, byAdmin, authorize)
  }
  ...
  setPinned(
    ...
    return this.inner.setPinned(roomId, messageId, byAdmin, authorize)
  }
  ...
  softDelete(
    ...
    return this.inner.softDelete(messageId, byMemberId, roomHint, authorize)
  }
  ...
  authorUnsend(
    ...
    return this.inner.authorUnsend(messageId, memberId, isAdmin, roomHint, authorize)
  }
  ...
  readUnreadSummary(room: string, memberId: string, watermark: number) {
    return this.inner.readUnreadSummary(room, memberId, watermark)
  }
  ...
  collectLiveBlobShas(): Promise<{ shas: Set<string>; complete: boolean }> {
